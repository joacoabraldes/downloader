"""CLI del monorepo de ETLs.
  ...
  python -m etl <dataset> [run|load-history] [flags]   # dataset: granos|cemento|automotriz|patentamientos|acero|aves
...
DATASETS = ["granos", "cemento", "automotriz", "patentamientos", "acero", "aves"]
