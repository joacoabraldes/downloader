"""CLI del monorepo de ETLs.
  ...
  python -m etl <dataset> [run|load-history] [flags]   # dataset: granos|cemento|automotriz|patentamientos|acero|aves|leche|bovinos|demanda_energia|hidrocarburos|escrituras_caba|icc|icg|datos_gob|comex|reservas_pasivos|compras_granos
...
DATASETS = ["granos", "cemento", "automotriz", "patentamientos", "acero", "aves", "leche",
            "bovinos", "demanda_energia", "hidrocarburos", "escrituras_caba", "icc", "icg",
            "datos_gob", "comex", "reservas_pasivos", "compras_granos"]
